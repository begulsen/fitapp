...
{
    public static class MealRepositoryExtension
    {
        public static IServiceCollection AddMealRepository(this IServiceCollection services)
        {
            MealRepositorySettings settings = new MealRepositorySettings();
            ...
            /*switch (environmentMode)
        {
            ...
            var repository = new MealRepository(elasticClient, settings);
            services.AddSingleton<IMealRepository>(repository);
