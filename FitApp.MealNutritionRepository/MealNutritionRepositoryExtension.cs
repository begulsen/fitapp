...
{
    public static class MealNutritionRepositoryExtension
    {
        public static IServiceCollection AddMealNutritionRepository(this IServiceCollection services)
        {
            MealNutritionRepositorySettings settings = new MealNutritionRepositorySettings();
            ...
            /*switch (environmentMode)
        {
            ...
            var repository = new MealNutritionRepository(elasticClient, settings);
            services.AddSingleton<IMealNutritionRepository>(repository);
