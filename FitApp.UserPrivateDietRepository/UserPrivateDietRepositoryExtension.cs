...
{
    public static class UserPrivateDietRepositoryExtension
    {
        public static IServiceCollection AddUserPrivateDietRepository(this IServiceCollection services)
        {
            UserPrivateDietRepositorySettings settings = new UserPrivateDietRepositorySettings();
            ...
            var repository = new UserPrivateDietRepository(elasticClient, settings);
            services.AddSingleton<IUserPrivateDietRepository>(repository);
