...
using FitApp.TrainingRepository.Settings;
using Microsoft.Extensions.DependencyInjection;
using Nest;

namespace FitApp.TrainingRepository
{
    public static class TrainingRepositoryExtension
    {
        public static IServiceCollection AddTrainingRepository(this IServiceCollection services)
        {
            TrainingRepositorySettings settings = new TrainingRepositorySettings();
            ...
            var repository = new TrainingRepository(elasticClient, settings);
            services.AddSingleton<ITrainingRepository>(repository);
